#ifndef __GX_TRANSFORM_POSITION_UV_SHADER_H__
#define __GX_TRANSFORM_POSITION_UV_SHADER_H__
...
namespace gx
{
	class transform_position_uv_vertex_shader_constant_buffer 
	{
		public:
	...
	class transform_position_uv_input_layout
	{
		...
		transform_position_uv_input_layout( ID3D11Device* device, transform_position_uv_vertex_shader* shader);
