...
namespace gx
{
	...
	{
		dx11::throw_if_failed<dx11::create_vertex_shader> (device->CreateVertexShader( gx_shader_screen_space_uv_vs, sizeof(gx_shader_screen_space_uv_vs), nullptr, dx11::get_pointer(m_shader)));
