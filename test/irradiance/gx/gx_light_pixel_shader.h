#ifndef __GX_LIGHT_PIXEL_SHADER_H__
#define __GX_LIGHT_PIXEL_SHADER_H__
...
namespace gx
{
	class __declspec(align(16)) light_pixel_shader_constant_buffer 
	{
		public:

		explicit light_pixel_shader_constant_buffer ( ID3D11Device* device );
	...
	class light_pixel_shader
    {
		...
		explicit light_pixel_shader ( ID3D11Device* device );
