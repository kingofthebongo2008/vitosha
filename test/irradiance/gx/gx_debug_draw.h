...
namespace gx
{
    ...
    inline void debug_draw_depth_buffer( ID3D11DeviceContext* device_context, render_context* render_context,  math::matrix_float44 projection_matrix, math::matrix_float44 screen_space_transform )
    {
