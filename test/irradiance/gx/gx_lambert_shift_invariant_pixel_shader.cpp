...
namespace gx
{
	...
	{
		dx11::throw_if_failed<dx11::create_pixel_shader> (device->CreatePixelShader( gx_shader_lambert_shift_invariant_ps, sizeof(gx_shader_lambert_shift_invariant_ps), nullptr, dx11::get_pointer(m_shader)));
