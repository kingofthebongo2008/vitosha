...
namespace gx
{
    ...
    {
        dx::throw_if_failed<d3d11::create_vertex_shader> (device->CreateVertexShader( gx_shader_transform_position_normal_uv_vs, sizeof(gx_shader_transform_position_normal_uv_vs), nullptr, dx::get_pointer(m_shader)));
