...
namespace gx
{
	...
	{
		dx::throw_if_failed<d3d11::create_pixel_shader> (device->CreatePixelShader( gx_shader_blinn_phong_shift_invariant_ps, sizeof(gx_shader_blinn_phong_shift_invariant_ps), nullptr, dx::get_pointer(m_shader)));
