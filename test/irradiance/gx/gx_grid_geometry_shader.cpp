...
namespace gx
{
	...
	{
		dx11::throw_if_failed<dx11::create_geometry_shader> (device->CreateGeometryShader( gx_shader_grid_gs, sizeof(gx_shader_grid_gs), nullptr, dx11::get_pointer(m_shader)));
