...
point_light_sphere_debug_vertex_shader_constant_buffer::point_light_sphere_debug_vertex_shader_constant_buffer ( ID3D11Device* device )
{
	...
	dx::throw_if_failed<d3d11::create_buffer_exception> (device->CreateBuffer(&desc, nullptr, dx::get_pointer(m_buffer) ));
}
...
{
	dx::throw_if_failed<d3d11::create_pixel_shader> (device->CreateVertexShader( shader_point_light_sphere_debug_vs, sizeof(shader_point_light_sphere_debug_vs), nullptr, dx::get_pointer(m_shader)));
