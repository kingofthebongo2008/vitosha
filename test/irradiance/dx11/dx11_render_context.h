...
namespace dx11
{
    ...
    class render_context : public boost::noncopyable
    {
		...
		render_context(system_context sys_context, std::uint32_t render_context_count);
    ...
    {
        public:
        explicit thread_render_context( id3d11devicecontext_ptr d3d11_device_context) : m_d3d11_device_context(d3d11_device_context)
        {
        ...
        void end_frame()
        {
            throw_if_failed<d3d11_exception>( m_d3d11_device_context->FinishCommandList(FALSE, dx11::get_pointer(m_command_list)));
        }
